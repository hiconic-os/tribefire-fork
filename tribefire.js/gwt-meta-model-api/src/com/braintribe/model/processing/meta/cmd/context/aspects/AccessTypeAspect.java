...
/**
 * Represents the type of the IncrementalAccess (it's denotation type, not actual implementation).
 * 
 * {@link UseCaseSelector}
 */

public class AccessTypeAspect extends SessionScopedAspect<String> {
	// blank
}
